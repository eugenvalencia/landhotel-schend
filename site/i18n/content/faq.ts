...
export const faqItems: Record<Locale, QA[]> = {
  ...
  nl: [
    ...
    { q: "Kan ik met een hond overnachten?", a: "Honden zijn welkom in onze dorpsherberg (Dorfgaststätte). In het hoofdgedeelte van het restaurant en in de kamers zijn honden helaas niet toegestaan — we vragen om uw begrip." },
    ...
    { q: "Kunnen jullie familie- of bedrijfsfeesten verzorgen?", a: "Ja. In de Eichelbergzaal vieren tot 70 personen, in de haardkamer 35, in de dorpsherberg en op het zonneterras elk 40 personen. Of het nu een verjaardag, doop, bruiloft of bedrijfsevenement is — we stellen menu of buffet samen met u op maat samen." },
