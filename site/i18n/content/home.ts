...
export const homeContent: Record<Locale, HomeContent> = {
  de: {
    ...
    hoursNote:
      "Mo–Mi kein À-la-carte — auf Anmeldung verwöhnen wir Sie gern mit unseren liebevoll kreierten Menüs.",
    ...
    platformLines: ["Sehr gut", "Nr. 1 in Immerath laut Tripadvisor", "100 % Weiterempfehlung", "Rezensionen auf Google lesen"],
    ...
    faqHome: [
      ...
      { q: "Wann hat das Hotel Saison?", a: "Aktuelle Öffnungs- und Saisonzeiten erfragen Sie am besten telefonisch unter +49 6573 306 — wir geben Ihnen gern Auskunft." },
    ],
  ...
  en: {
    ...
    hoursNote:
      "Mon–Wed no à-la-carte — by prior arrangement we are happy to spoil you with our lovingly created set menus.",
    ...
    platformLines: ["Very good", "No. 1 in Immerath on Tripadvisor", "100 % would recommend", "Read reviews on Google"],
    ...
    faqHome: [
      ...
      { q: "When is the hotel's season?", a: "It's best to ask about current opening and season times by phone on +49 6573 306 — we'll gladly help." },
    ],
  ...
  fr: {
    ...
    hoursNote:
      "Lun–mer pas de carte — sur réservation, nous vous régalons avec plaisir de nos menus préparés avec soin.",
    ...
    platformLines: ["Très bien", "n° 1 à Immerath sur Tripadvisor", "100 % de recommandation", "Lire les avis sur Google"],
    ...
    faqHome: [
      ...
      { q: "Quelle est la saison de l'hôtel ?", a: "Le mieux est de vous renseigner sur les horaires d'ouverture et de saison actuels par téléphone au +49 6573 306 — nous vous renseignons volontiers." },
    ],
  ...
  nl: {
    ...
    hoursNote:
      "Ma–wo geen à la carte — op aanmelding verwennen wij u graag met onze met zorg samengestelde menu's.",
    ...
    platformLines: ["Zeer goed", "nr. 1 in Immerath volgens Tripadvisor", "100 % aanbeveling", "Beoordelingen op Google lezen"],
    ...
    faqHome: [
      ...
      { q: "Wanneer heeft het hotel seizoen?", a: "Vraag de actuele openings- en seizoenstijden het best telefonisch op via +49 6573 306 — wij geven u graag uitleg." },
    ],
