...
export const homeContent: Record<Locale, HomeContent> = {
  de: {
    ...
    platformLines: ["Nr. 1 von 4 Hotels in Immerath", "Sehr gut bewertet", "Weiterempfehlung laut HRS", "Rezensionen auf Google lesen"],
  ...
  en: {
    ...
    platformLines: ["No. 1 of 4 hotels in Immerath", "Very good rating", "Would recommend, per HRS", "Read reviews on Google"],
  ...
  fr: {
    ...
    platformLines: ["N° 1 sur 4 hôtels à Immerath", "Très bien noté", "Recommandation selon HRS", "Lire les avis sur Google"],
  ...
  nl: {
    ...
    platformLines: ["Nr. 1 van 4 hotels in Immerath", "Zeer goed beoordeeld", "Aanbeveling volgens HRS", "Beoordelingen op Google lezen"],
