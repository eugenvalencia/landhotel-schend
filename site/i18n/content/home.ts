...
export const homeContent: Record<Locale, HomeContent> = {
  de: {
    ...
    platformLines: ["Sehr gut · Nr. 1 in Immerath", "Nr. 1 in Immerath", "100 % Weiterempfehlung", "Rezensionen auf Google lesen"],
  ...
  en: {
    ...
    platformLines: ["Very good · No. 1 in Immerath", "No. 1 in Immerath", "100 % would recommend", "Read reviews on Google"],
  ...
  fr: {
    ...
    platformLines: ["Très bien · n° 1 à Immerath", "n° 1 à Immerath", "100 % de recommandation", "Lire les avis sur Google"],
  ...
  nl: {
    ...
    platformLines: ["Zeer goed · nr. 1 in Immerath", "nr. 1 in Immerath", "100 % aanbeveling", "Beoordelingen op Google lezen"],
