...
export const homeContent: Record<Locale, HomeContent> = {
  de: {
    ...
    platformLines: ["Sehr gut", "Sehr gut bewertet", "Weiterempfehlung laut HRS", "Rezensionen auf Google lesen"],
  ...
  en: {
    ...
    platformLines: ["Very good", "Very good rating", "Would recommend, per HRS", "Read reviews on Google"],
  ...
  fr: {
    ...
    platformLines: ["Très bien", "Très bien noté", "Recommandation selon HRS", "Lire les avis sur Google"],
  ...
  nl: {
    ...
    platformLines: ["Zeer goed", "Zeer goed beoordeeld", "Aanbeveling volgens HRS", "Beoordelingen op Google lezen"],
